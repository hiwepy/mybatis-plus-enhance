...
- CI-Friendly versions: the root POM and all modules use `${revision}` (default `1.0.x.20260630-SNAPSHOT`), flattened via `flatten-maven-plugin`. Build a concrete release without touching POMs:
